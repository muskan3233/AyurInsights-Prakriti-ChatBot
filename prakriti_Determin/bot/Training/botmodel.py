...
df.to_csv(rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\dataset\sentences_intent.csv", index=False)
...
dump(model, rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\models\nlm")
