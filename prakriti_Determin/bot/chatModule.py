...
PATH = os.getcwd()
model = load(rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\models\nlm")
prakrit_model = load(rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\models\trained_model")

# Importing the Sentence intent .csv file
df = pd.read_csv(rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\dataset\sentences_intent.csv")

# Importing the json file for getting the responses
with open(rf"C:\Users\Muska\Downloads\prakriti\prakriti_Determin\bot\intents.json", "r") as f:
